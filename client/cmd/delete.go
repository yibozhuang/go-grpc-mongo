...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "Delete blog post by ID",
	Long: `Delete a blog post over gRPC
Please use the mongo unique identifier as the ID`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Printf("Succesfully deleted the blog with ID %s", id)
        fmt.Println()
	},
}
